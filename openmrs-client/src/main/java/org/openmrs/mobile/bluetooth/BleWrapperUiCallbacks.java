...
public interface BleWrapperUiCallbacks {
	...
	public void uiNewValueHRForCharacteristic(final BluetoothGatt gatt,
											  final BluetoothDevice device,
											  final BluetoothGattService service,
											  final BluetoothGattCharacteristic ch,
											  final String strValue,
	...
	public static class Null implements BleWrapperUiCallbacks {
		...
		@Override
		public void uiNewValueHRForCharacteristic(BluetoothGatt gatt,
												  BluetoothDevice device, BluetoothGattService service,
												  BluetoothGattCharacteristic ch, String strValue, int intValue,
												  byte[] rawValue, String timestamp) {
		}
		...
		@Override
		public void uiNewValuePressForCharacteristic(BluetoothGatt gatt,
													 BluetoothDevice device, BluetoothGattService service, int systolic,
