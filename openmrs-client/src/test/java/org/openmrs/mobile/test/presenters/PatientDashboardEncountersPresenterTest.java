...
public class PatientDashboardEncountersPresenterTest extends ACUnitTestBaseRx {

    @Mock
    private PatientDashboardContract.ViewPatientEncounters view;
    @Mock
    ...
    private PatientDashboardEncountersPresenter presenter;
    ...
    public void setUp(){
        ...
        presenter = new PatientDashboardEncountersPresenter(patient, view, visitDAO, visitApi);
    ...
    public void shouldShowPatientsVisitsOnStartUp_allOK(){
        ...
        verify(view, atLeast(1)).setEncountersToDisplay(visitsList);
    }
    ...
    public void shouldSyncVisits_allOK(){
        ...
        verify(view).setEncountersToDisplay(visitsList);
        verify(view).showStartVisitDialog(false);
    }
    ...
    public void shouldStartVisit_allOK(){
        ...
        verify(view).goToFormViewActivity(1L);
